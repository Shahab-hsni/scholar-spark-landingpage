...
const ProblemSection: React.FC = () => {
  ...
  return <section id="problem" className="py-24 px-6 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          once: true
              ...
              <div className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700/50 hover:border-red-500/30 transition-all duration-500 backdrop-blur-sm h-full">
                {/* Background Gradient */}
                <div className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-5 rounded-2xl group-hover:opacity-10 transition-opacity duration-500`} />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                ...
                <div className="text-sm text-gray-400">Annual research waste due to inefficiency</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-orange-400 mb-2">2.5 years</div>
                <div className="text-sm text-gray-400">Average delay in breakthrough discoveries</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-yellow-400 mb-2">40%</div>
                <div className="text-sm text-gray-400">Of research projects are unknowingly duplicated</div>
              </div>
            </div>
          </div>
        </motion.div>
