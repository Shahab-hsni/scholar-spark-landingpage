...
export const AnimatedGeometricBackground: React.FC<AnimatedGeometricBackgroundProps> = ({
  className = '',
  opacity = 0.08,
}) => {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      if (!svgRef.current || !maskCircleRef.current) return;
      ...
      // Debug logging
      console.log('Mouse position:', { x, y, clientX: e.clientX, clientY: e.clientY });

      // Update mask circle position
      maskCircleRef.current.setAttribute('cx', x.toString());
      maskCircleRef.current.setAttribute('cy', y.toString());
    };
      ...
      >
        <defs>
          ...
          <mask id="spotlight-mask">
            ...
            <circle ref={maskCircleRef} cx="486.5" cy="486.5" r="300" fill="white" />
          </mask>

          {/* Radial Gradient for Spotlight */}
          <radialGradient id="spotlight-gradient" cx="0.5" cy="0.5" r="0.5">
        ...
        {/* Base Layer - Always Visible (Subtle) */}
        <g opacity="0.6">
          {/* Debug: Visible spotlight circle */}
          <circle
            cx="486.5"
            cy="486.5"
            r="300"
          ...
          <path opacity="0.3" d="M486.5 486.5L655.024 389.2" stroke="white" strokeWidth="2.4325" />
          <path opacity="0.3" d="M486.5 486.5L655.024 583.8" stroke="white" strokeWidth="2.4325" />
          ...
          <path opacity="0.3" d="M486.5 486.5L823.547 291.9" stroke="white" strokeWidth="2.4325" />
          <path opacity="0.3" d="M486.5 486.5L823.547 681.1" stroke="white" strokeWidth="2.4325" />
          ...
          <path
            ...
            strokeWidth="2.4325"
          />
          <path opacity="0.3" d="M486.5 291.9L655.024 389.2" stroke="white" strokeWidth="2.4325" />
          <path
            opacity="0.3"
          ...
          <path
            ...
            strokeDasharray="4.86 4.86"
          />
          <path opacity="0.3" d="M655.024 583.8L486.5 681.1" stroke="white" strokeWidth="2.4325" />
          <path
            opacity="0.3"
          ...
          <path
            ...
            strokeWidth="2.4325"
          />
          <path opacity="0.3" d="M655.024 583.8L486.5 875.7" stroke="white" strokeWidth="2.4325" />
          <path
            opacity="0.3"
          ...
          <path
            ...
            strokeWidth="2.4325"
          />
          <path opacity="0.3" d="M317.979 389.2L486.502 97.3" stroke="white" strokeWidth="2.4325" />
          <path
            opacity="0.3"
          ...
          <path opacity="0.3" d="M486.501 97.3L149.454 681.1" stroke="white" strokeWidth="2.4325" />
          <path opacity="0.3" d="M486.501 97.3L149.454 291.9" stroke="white" strokeWidth="2.4325" />
          <path opacity="0.3" d="M823.549 291.9V681.1" stroke="white" strokeWidth="2.4325" />
          <path opacity="0.3" d="M823.547 291.9L486.5 875.7" stroke="white" strokeWidth="2.4325" />
          <path
            opacity="0.2"
          ...
          <path opacity="0.3" d="M823.547 681.1L486.5 875.7" stroke="white" strokeWidth="2.4325" />
        ...
        {/* Highlight Layer - Masked with Spotlight (Vibrant) */}
        <g opacity="1" mask="url(#spotlight-mask)">
          {/* Animated connecting lines */}
          <motion.path
            opacity="0.8"
            d="M486.5 486.5V291.9"
            stroke="#FF0000"
            strokeWidth="4"
          ...
          <motion.path
            ...
            fill="#FF0000"
            animate={{ scale: [1, 1.2, 1], opacity: [0.8, 1, 0.8] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 3.3 }}
          />
        </g>
      </svg>
    </div>
